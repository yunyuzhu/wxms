...
<script src="app/js/back/bkgoodmanage.js" type="text/javascript" charset="UTF-8"></script>
                ...
                <div class="row">
                    <div class="col-xs-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="ct-input-frame">
                                    <input type="text" class="form-control" id="name" value="" placeholder="输入商品名称">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="form-group mustfill">
                                <label for="namePop" class="col-sm-2 control-label"><i>*</i>商品名称</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="namePop" value="" placeholder="输入商品名称">
                                </div>
                            </div>
                            <div class="form-group mustfill">
                                <label for="pricePop" class="col-sm-2 control-label"><i>*</i>商品价格</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="pricePop" value="" placeholder="输入商品价格">
                                </div>
                            </div>
                            <div class="form-group">
