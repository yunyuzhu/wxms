...
public class TreeUtil {
	 ...
	 * @return
	 */
	public List<Menu> getChildObjects(List<Menu> list, int praentId) {
	 ...
	 * @param t
	 */
	private void  recursionFn2(List<Menu> list, Menu t) {
		List<Menu> childList = getChildList2(list, t);// 得到子节点列表
		t.setChildren(childList);
		for (Menu tChild : childList) {
			if (hasChild2(list, tChild)) {// 判断是否有子节点
				//returnList.add(TreeObject);
	 ...
	 * @return
	 */
	private List<Menu> getChildList2(List<Menu> list, Menu t) {
	 ...
	 * @return
	 */
	private boolean hasChild2(List<Menu> list, Menu t) {
