...
public class ShopManageController {
	...
	public Object saveUser(
		...
		try {
			...
			return shopManageServiceImpl.saveUserAndRole(userName, accountName, password, roleId, depaId, useFlag, remark, tenantName, trade, address, telephone, linkName, linkPhone);
		} catch (Exception e) {
	...
	public Object updateUser(
			...
			@ApiParam(required = true, name = "depaId", value = "部门id") @RequestParam(value = "depaId", required = false) Integer depaId,
			@ApiParam(required = true, name = "useFlag", value = "启用状态") @RequestParam(value = "useFlag", required = true) String useFlag,
			@ApiParam(required = true, name = "tenantName", value = "商户名称") @RequestParam(value = "tenantName", required = true) String tenantName,
			@ApiParam(required = true, name = "trade", value = "行业") @RequestParam(value = "trade", required = true) String trade,
			@ApiParam(required = true, name = "address", value = "地址") @RequestParam(value = "address", required = true) String address,
			@ApiParam(required = true, name = "telephone", value = "商户电话") @RequestParam(value = "telephone", required = true) String telephone,
			@ApiParam(required = true, name = "linkName", value = "联系人姓名") @RequestParam(value = "linkName", required = true) String linkName,
			@ApiParam(required = true, name = "linkPhone", value = "联系人电话") @RequestParam(value = "linkPhone", required = true) String linkPhone,
			@ApiParam(required = false, name = "remark", value = "备注") @RequestParam(value = "remark", required = false) String remark) {
		...
		try {
			...
			return shopManageServiceImpl.updateUserAndRole(userId,accountName, roleId, depaId, useFlag, remark, tenantName, trade, address, telephone, linkName, linkPhone);
		} catch (Exception e) {
			return HttpResult.build(false, "1000", "保存失败！");
		}
	}
